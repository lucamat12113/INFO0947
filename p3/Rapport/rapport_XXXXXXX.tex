...
\textit{\textbf{Transfo(s[0])}} {\large si n = 0}
...
\textit{\textbf{Traitement(s[n], n) + Traitement(s, n-1)}} {\large sinon}
\end{center}
...
utilisable et donc que sa longueur n'est pas nulle. Dans le pseudo code 
